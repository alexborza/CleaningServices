...
insert into job_information (id, hiring_date, salary, work_phone) values (10001, null, null, null);
...
insert into messages (cleaning_service_id, messages_order, content, message_date, sender) values (10001, 0, 'message1', '2023-02-03', 'panda');
insert into messages (cleaning_service_id, messages_order, content, message_date, sender) values (10001, 1, 'message2', '2023-02-03', 'samson');
